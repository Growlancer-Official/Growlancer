...
- [ ] **Abuse / AI cost:** rate limits actually apply to signup, OTP/confirm, messaging spam, file uploads, and the AI functions (Gemini LLM credits) — an unthrottled loop is direct cost-abuse.
