      ...
      <div className="relative w-full max-w-md bg-white rounded-xl shadow-2xl border border-slate-200 p-4 animate-fade-in">
        ...
        <div className="grid grid-cols-2 gap-3 mb-2.5">
          <button
            ...
            className={`flex items-center justify-center gap-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${
              mode === 'password'
        ...
        {phase === 'success' ? (
          ...
          >
                ...
                {!otpSent ? (
                  <div className="text-center">
                    <button
                      ...
                      onClick={sendOtp}
                      disabled={sendingOtp}
                      className="inline-flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white border border-emerald-300 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-all disabled:opacity-50"
                    >
            ...
            <button
              ...
              className="w-full h-12 bg-emerald-600 text-white font-semibold rounded-xl shadow-lg shadow-emerald-600/25 hover:bg-emerald-700 hover:shadow-xl transition-all flex items-center justify-center gap-3 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {phase === 'verifying' ? (
                <>
                  <span>Verifying...</span>
