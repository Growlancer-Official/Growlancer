      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto">
          <nav className="space-y-0.5">
            {sidebarGroups.map((group) => (              <div key={group.label} className="mb-0.5">
          ...
          <div className="mt-3 pt-3 border-t border-slate-200 space-y-1">              <Link
              to="/"
              onClick={() => setMobileNavOpen(false)}
      ...
      <aside className="w-56 sticky top-0 h-screen hidden lg:flex flex-col p-3 z-50 overflow-y-auto bg-white border-r border-slate-200">
        ...
        <Link to="/" className="flex items-center gap-2 mb-4 px-1.5">
          ...
          <div>
            ...
            <span className="text-[8px] uppercase tracking-widest text-slate-400 font-bold">Freelancer</span>
          </div>
        </Link>
        ...
        <div className="mt-3">
          <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-100">
            <p className="text-[10px] text-emerald-800 font-semibold mb-0.5">AI Boost Active</p>
            <p className="text-[9px] text-emerald-600 leading-relaxed mb-2">
              {newMatchCount > 0
            ...
            <Link
              to="/dashboard/feed"
              className="block w-full py-1.5 bg-emerald-600 text-white text-[10px] font-bold rounded-lg hover:bg-emerald-700 transition-colors text-center"
            >
              View Matches
            </Link>
          </div>
