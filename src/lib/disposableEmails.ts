// ────────────────────────────────────────────────────────────────────────────
// Disposable / temporary email domain blocklist (curated, production)
// Mirrors the server-side trigger in supabase/migrations
// (is_disposable_email_domain) and the newsletter-subscribe edge function.
//
// Every domain here is a real, widely-used disposable / throwaway provider.
// Subdomains are matched too (foo.mailinator.com is blocked as well).
// ────────────────────────────────────────────────────────────────────────────

export const DISPOSABLE_EMAILS: readonly string[] = [
  ...
  // ── Additional commonly used disposable providers (2026) ──
  'emalupe.com', 'burnermail.io', 'burnermail.net', 'burnermail.org',
  'maildrop.cc', 'maildrop.net', 'mailsac.com', 'mailnesia.com',
  'guerillamail.com', 'guerillamail.de', 'guerillamail.net', 'guerillamail.org',
  'guerillamail.biz', 'guerillamailblock.com', 'grr.la',
  'yopmail.fr', 'yopmail.net', 'yopmail.org', 'yopmail.gq',
  'secmail.com', 'secmail.net', 'secmail.org',
  'boun.cr', 'discard.email', 'discardmail.com', 'discardmail.de',
  'emailfake.com', 'email-fake.com', 'fakemailgenerator.com',
  'sharklasers.com', 'getairmail.com', 'getnada.com', 'nada.email',
  'spamgourmet.com', 'spamgourmet.net', 'spamgourmet.org',
  'xoxy.net', 'throwaway.email', 'throwawaymail.com',
  'anonmails.de', 'anonbox.net', 'anonmail.top',
  'tmpmail.org', 'tmpmail.net', 'tmpmail.com', 'tmpmail.top',
  'mailcatch.com', 'mail7.io', 'mailmetrash.com',
  'spam4.me', 'spamherelots.com', 'spamherelots.net',
  'emaildrop.io', 'opayq.com', 'oborepo.com',
  'moakt.com', 'moakt.net', 'moakt.ws', 'meltmail.com',
  'gustr.com', 'guerillamail.me', 'guerrillamail.info',
  'dispostable.com', 'maildrop.cc', 'mohmal.com', 'mail.tm',
  'dropmail.me', 'burnermail.io', 'incognitomail.com',
  'wegwerfmail.de', 'wegwerfemail.de', 'wegwerfemail.com',
  'trashmail.de', 'trashmail.at', 'trashmail.com', 'trashmail.me',
  'trashymail.com', 'trashymail.net', 'trashemail.de',
  'spambox.us', 'spambob.com', 'spambob.net', 'spambog.com',
  'spamfree24.com', 'spamfree24.de', 'spamfree24.org',
  'spamhole.com', 'spamex.com', 'spamcannon.com',
  'spamfighter.cf', 'spamfighter.ga', 'spamfighter.tk',
  'sneakemail.com', 'sneakymail.de', 'snkmail.com',
  'tmailinator.com', 'teleworm.com', 'teleworm.us',
  'supermailer.jp', 'twinmail.de', 'wuzup.net', 'wuzupmail.net',
  'yomail.info', 'yomail.org', 'yapped.net',
  'zehnminutenmail.de', 'zoemail.org', 'you-spam.com',
  'mailfree.ga', 'mailfree.ml', 'abyssemail.com', 'abyssmail.com',
  'mailhz.me', 'mailexpire.com', 'nowmymail.com',
  'proxymail.eu', 's0ny.net', 'safetypost.de', 'shitmail.me',
  'slipry.net', 'smashmail.de', 'smellfear.com', 'snakemail.com',
  'sogetthis.com', 'soodonims.com', 'spamavert.com',
  ...
  'superrito.com', 'superrimal.com', 'teleworm.com',
  'tempalias.com', 'tempemail.biz', 'tempemail.co.za', 'tempemail.net',
  'tempinbox.co.uk', 'tempinbox.com', 'tempmail.eu', 'tempmail.it',
  'tempmail.plus', 'tempmail2.com', 'tempmailer.com', 'tempmailer.de',
  'tempomail.fr', 'temporaryemail.net', 'temporaryemail.us',
  'temporaryforwarding.com', 'temporaryinbox.com',
  'temporarymailaddress.com', 'tempthe.net', 'thetempmail.com',
  'throwawayemailaddress.com', 'toiea.com', 'toomail.biz',
  'tradermail.info', 'trash-me.com', 'trash-me.net',
  'trashcanon.com', 'trashdevil.com', 'trashdevil.de',
  'trashmailer.com', 'trayna.com', 'trbvm.com', 'trbvn.com', 'trbvo.com',
  'turual.com', 'tyldd.com', 'umail.net',
  'venompen.com', 'veryrealliemail.com', 'vomoto.com', 'vpn.st',
  'vsimcard.com', 'vubby.com', 'webemail.me',
  'weg-werf-email.de', 'wegwerfadresse.de', 'wegwerfemail.net', 'wegwerfemail.org',
  ...
  'xmaily.com', 'yeah.net', 'yep.it', 'yogamaven.com',
...
export const DISPOSABLE_EMAIL_SET: ReadonlySet<string> = new Set(DISPOSABLE_EMAILS);

/**
 * Returns true when the email's domain (or any parent subdomain) is disposable.
 * e.g. foo.mailinator.com → mailinator.com matches.
 */
export function isDisposableEmailDomain(email: string): boolean {
  ...
  for (;;) {
    if (DISPOSABLE_EMAIL_SET.has(domain)) return true;
