  ...
  const fetchMetrics = useCallback(async () => {
    try {
      ...
      const [
        ...
        supabase.from('profiles').select('*', { count: 'exact', head: true }).is('deleted_at', null).gte('created_at', monthAgo),
        supabase.from('profiles').select('*', { count: 'exact', head: true }).is('deleted_at', null).gte('created_at', twoMonthsAgo).lt('created_at', monthAgo),
