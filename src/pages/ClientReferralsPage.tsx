        ...
        <div className="lg:col-span-2 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-[0_10px_40px_-10px_rgba(16,185,129,0.12)] relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch gap-1.5 mb-8">
              <div className="flex-1 bg-slate-50 px-2.5 py-3.5 rounded-xl border border-slate-200 flex items-center justify-between font-mono text-lg font-bold text-slate-800">
                {referralCode}
                <button
                  onClick={handleCopy}
              ...
              <button
                onClick={handleCopy}
                className="px-3 py-3 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 transition-all inline-flex items-center justify-center gap-2"
              >
