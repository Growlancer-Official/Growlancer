        ...
        <div className="lg:col-span-2 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-[0_10px_40px_-10px_rgba(16,185,129,0.12)] relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch gap-3 mb-8">
              <div className="flex-1 bg-slate-50 px-5 py-3.5 rounded-xl border border-slate-200 flex items-center justify-between font-mono text-lg font-bold text-slate-800">
                {referralCode}
                <button
                  onClick={handleCopy}
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="bg-white p-6 rounded-3xl border border-slate-100 hover:border-emerald-100 transition-all group">
            <div className="h-12 w-12 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 mb-5 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-100 hover:border-emerald-100 transition-all group">
            <div className="h-12 w-12 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 mb-5 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-100 hover:border-emerald-100 transition-all group">
            <div className="h-12 w-12 rounded-xl bg-slate-900 flex items-center justify-center text-white mb-5 group-hover:scale-110 transition-transform">
        ...
        <div className="xl:col-span-2 bg-white rounded-[2rem] p-8 border border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
              <p className="text-[11px] font-bold text-slate-400 uppercase mb-2 tracking-widest">Why no cash?</p>
