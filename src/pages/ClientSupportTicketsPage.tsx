  ...
  return (
    <div className="h-[calc(100vh-8rem)]">
      ...
      <TipNote tone="info" title="Support vs. AI Assistant" compact className="mb-3">
        This is <strong>Growlancer Support</strong> — for help with payments, escrow, verification, contracts and account issues. The <strong>AI Assistant</strong> (in your client dashboard) is separate — it helps you write project briefs, find freelancers and plan work. The two chats never mix.
      </TipNote>
      <AIChatSupport 
        context="client" 
        chatMode="support"
